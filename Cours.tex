...
\end{cases}$\newline \newline
On se place dans l'approximation acoustique : $|p'|\ll P_0$; $v'\ll v_0$; $\mu'\ll \rho_0$\newline
...
\begin{center}
\fbox{$\frac{\partial^2 p'(x',t)}{\partial t^2}-2v_0\frac{\partial^2p'(x',t)}{\partial x'\partial t}=(c^2-v_0^2)\frac{\partial^2p'(x',t)}{\partial x'^2}$}
\end{center}
